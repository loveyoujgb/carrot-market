...
import detailSlice, { changeMode, __getDetail, __postUserHeart } from "../redux/modules/detailSlice";
    ...
    <>
      <ViewItemWrap>
        ...
        <FirstWrap>
          ...
          >
            {/* {detail.file.map( (photo) =>
           ( <SwiperSlide>
            <ItemImg back={photo}></ItemImg>
          </SwiperSlide>
          )
          )} */}
        ...
        <UserInfoFirstWrap>
          <UserInfoWrap>
            ...
            <UerInpo>
              ...
              {/* <Username to="/">{detail.username}</Username> */}
